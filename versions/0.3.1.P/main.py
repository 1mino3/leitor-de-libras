...
class LeitorDeLibras(QMainWindow):
    ...
    def update_frame(self):
        ...
        Os comandos em comentários, desenho dos pontos e desenho das conexões, são usado para fins de desenvolvimento. Caso esteja testando ou experimentando, não é necessária a utilização dos mesmos.
